        ...
        <div className="relative bg-white rounded-lg shadow-xl shadow-gray-200 border border-indigo-100">
          ...
          <div className="flex items-center p-4 px-6 rounded-b">
            <button
              onClick={onClick}
              type="button"
              className="text-white bg-gradient-to-r from-indigo-500 to-indigo-600 focus:ring-4 focus:outline-none focus:ring-indigo-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
            >
              Submit
            </button>
          </div>
